...
type UserServiceClient interface {
	...
	Auth(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*AuthTokensResponse, error)
	GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*UserResponse, error)
	RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*AuthTokensResponse, error)
}
...
func (c *userServiceClient) Auth(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*AuthTokensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (c *userServiceClient) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*AuthTokensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthTokensResponse)
...
type UserServiceServer interface {
	...
	Auth(context.Context, *UserLoginRequest) (*AuthTokensResponse, error)
	GetByUsername(context.Context, *GetByUsernameRequest) (*UserResponse, error)
	RefreshToken(context.Context, *RefreshTokenRequest) (*AuthTokensResponse, error)
...
func (UnimplementedUserServiceServer) Auth(context.Context, *UserLoginRequest) (*AuthTokensResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Auth not implemented")
}
func (UnimplementedUserServiceServer) GetByUsername(context.Context, *GetByUsernameRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByUsername not implemented")
}
func (UnimplementedUserServiceServer) RefreshToken(context.Context, *RefreshTokenRequest) (*AuthTokensResponse, error) {
...
func _UserService_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Auth(ctx, req.(*UserLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
